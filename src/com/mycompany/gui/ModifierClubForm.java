 ...
 * @author Lenovo
 */
public class ModifierClubForm extends BaseForm {
    
    
    Form current;
    public ModifierClubForm(Resources res ) {
        ...
        TextField telephone = new TextField("", "entrer telephone!!");
        telephone.setUIID("TextFieldBlack");
        addStringValue("telephone",telephone);
        
         TextField type_activite = new TextField("", "entrer type_activite !!");
        type_activite.setUIID("TextFieldBlack");
        addStringValue("type_activite",type_activite);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(id.getText().equals("") ) {
                    ...
                    Club ar = new Club(String.valueOf(nom.getText()).toString(),String.valueOf(localisation.getText()).toString(),String.valueOf(telephone.getText()).toString(),String.valueOf(description.getText()).toString(),String.valueOf(type_activite.getText()).toString());
                    
                    System.out.println("data  club == "+id2);
                    
                    
                    //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base 
                    ServiceClub.getInstance().modifierClub(ar);
