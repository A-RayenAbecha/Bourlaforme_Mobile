...
public class ListParticipationForm extends BaseForm {
    private ServiceParticipation as = new ServiceParticipation();
     ...
     Form current;
      public ListParticipationForm(Resources res) {
        ...
        // special case for rotation
         ...
         participations = as.affichageParticipations();
 ...
 for (int participation = 0;participation<participations.size() ; participation++) {
         //  System.out.println("TESTTTTTTTTTTT==");
             ...
             URLImage urlim = URLImage.createToStorage(enc, urlImage, urlImage, URLImage.RESIZE_SCALE);
                ...
                addButton(urlim,participations.get(participation),res);
...
refreshTheme();//Actualisation
    ...
    private void addButton(Image img,Participation ar , Resources res) {
      ...
      /*  TextArea ta = new TextArea(objet);
        ...
        Label IdClubTxt = new Label("id_club : "+ar.getId_club(),"NewsTopLine2" );
        Label dateDebutTxt = new Label("date debut : "+ar.getDateDebut(),"NewsTopLine2");
        Label dateFinTxt = new Label("date fin: "+ar.getDateFin(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ServiceParticipation.getInstance().deleteParticipation(ar.getId())) {
        ...
        lModifier.setTextPosition(LEFT);
         ...
         lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierParticipationForm(res).show();
        });
