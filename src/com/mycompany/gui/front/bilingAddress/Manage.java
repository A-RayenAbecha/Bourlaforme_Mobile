 ...
 */
package com.mycompany.gui.front.bilingAddress;
...
public class Manage extends Form {
    ...
    private void addActions() {
        ...
        manageButton.addActionListener(action -> {
            if (controleDeSaisie()) {
                ...
                if (responseCode == 200) {
                    new com.mycompany.gui.front.panier.Payment(this).show();
                } else {
    ...
    private void showBackAndRefresh() {
        ((com.mycompany.gui.front.panier.ShowAll) previous).refresh();
        previous.showBack();
    }
