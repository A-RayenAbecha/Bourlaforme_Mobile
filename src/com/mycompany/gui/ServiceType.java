 ...
 */
public class ServiceType extends BaseForm{
    
      Form current;
         
          public ServiceType(Resources res)
          {
     ...
     /*     Toolbar tb = new Toolbar(true);
        ...
        */
        Button btnClub = new Button("Clubs");
        addStringValue("", btnClub);
...
btnClub.addActionListener((e) -> {  //Appui sur boutton Service
            try {
 InfiniteProgress ip = new InfiniteProgress();; //Loading  after insert data
       final Dialog iDialog = ip.showInfiniteBlocking();
iDialog.dispose(); //na7io loading ba3d ma3mlna ajout
...
/////////
/*
btnSeance.addActionListener((e) -> {  //Appui sur boutton Service
            try {
 InfiniteProgress ip = new InfiniteProgress();; //Loading  after insert data
       final Dialog iDialog = ip.showInfiniteBlocking();
iDialog.dispose(); //na7io loading ba3d ma3mlna ajout
