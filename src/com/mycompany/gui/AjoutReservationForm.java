...
public class AjoutReservationForm extends BaseForm{
    ...
    private Reservation c = new Reservation();
    private ServiceReservation cs = new ServiceReservation();
    ...
    public AjoutReservationForm(Resources res){
     ...
     /*   Component.setSameSize(radioContainer, s1, s2);
       ...
       */ 
        ...
        TextField seance = new TextField("", "entrer ID Seance!!");
        seance.setUIID("TextFieldBlack");
        addStringValue("Id",seance);
         ...
         public void actionPerformed(ActionEvent e) {
             try {
                 ...
                 if(seance.getText().equals(""))  {
                     ...
                     //
                     int seance_id =  Float.valueOf(seance.getText()).intValue();
                            
                      
                     Reservation r = new Reservation(seance_id);
                     
                     
                     
                     
                     System.out.println("data  reservation == "+r.getSeance());
