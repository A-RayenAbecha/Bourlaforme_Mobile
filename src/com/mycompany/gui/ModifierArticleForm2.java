 ...
 * @author Lenovo
 */
public class ModifierArticleForm2 extends BaseForm {
    
    
    Form current;
    public ModifierArticleForm2(Resources res ,Article a) {
...
*/
        ...
        TextField id = new TextField(String.valueOf(a.getId()), "entrer Id!!");
        id.setUIID("TextFieldBlack");
        addStringValue("Id",id);
        
          TextField description = new TextField(a.getDescription(), "entrer description!!");
        description.setUIID("TextFieldBlack");
        addStringValue("Description",description);
        
          TextField nom = new TextField(a.getNom(), "entrer nom!!");
        nom.setUIID("TextFieldBlack");
        addStringValue("Nomt",nom);
        
          TextField prix = new TextField(String.valueOf(a.getPrix()), "entrer prix!!");
