 ...
 */
public class ListArticleBack extends BaseForm {
    ...
    private List<Article> articles;
     Form current;
    public ListArticleBack(Resources res) {
    ...
    for (int article = 0;article<articles.size() ; article++) {
         //  System.out.println("TESTTTTTTTTTTT==");
             ...
             URLImage urlim = URLImage.createToStorage(enc, urlImage, urlImage, URLImage.RESIZE_SCALE);
                ...
                addButton(urlim,articles.get(article),res);
  ...
  ////
    ...
    private void addButton(Image img,Article ar , Resources res) {
      ...
      /*  TextArea ta = new TextArea(objet);
        ...
        Label EtatTxt = new Label("Etat : "+ar.getEtat(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cet article ?","Annuler","Oui")) {
               ...
               ServiceArticle.getInstance().deleteArticle(ar.getId());
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierArticleForm2(res,ar).show();
        });
        //Update icon 
       /* Label lModifier = new Label("Modifier ");
        lModifier.setUIID("NewsTopLine");
        ...
        lModifier.addPointerPressedListener(l -> {
            //System.out.println("hello update");
            new ModifierArticleForm(res).show();
        });*/
