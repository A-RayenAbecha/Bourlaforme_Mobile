...
public class AjoutCommentaireForm2 extends BaseForm{
    ...
    Form current;
    public AjoutCommentaireForm2(Resources res, Article ar){
...
/*
  ...
  */      
        ...
        TextField article = new TextField(String.valueOf(ar.getId()), "entrer ID Article!!");
        article.setUIID("TextFieldBlack");
        addStringValue("Id",article);
         ...
         public void actionPerformed(ActionEvent e) {
             try {
                 ...
                 if(auteur.getText().equals(""))  {
                     ...
                     //
                     int article_id =  Float.valueOf(article.getText()).intValue();
                            
                        String aut=     String.valueOf(auteur.getText()).toString();
                         String cont=    String.valueOf(contenu.getText()).toString();
                     //
                     Commentaire r = new Commentaire(article_id,aut,cont);
                     ...
                     ServiceCommentaire.getInstance().ajoutCommentaire(r);
                   ...
                   //  iDialog.dispose(); //na7io loading ba3d ma3mlna ajout
                    ...
                    new ListArticleForm(res).show();
                      ...
                      System.out.println("data  reclamation == "+r.getAuteur());
...
refreshTheme();//Actualisation
        ...
        ////
        commentaires = cs.getAllCommentaire();
 ...
 for (int commentaire = 0;commentaire<commentaires.size() ; commentaire++) {
         //  
         if (commentaires.get(commentaire).getArticle()==ar.getId())
         {
