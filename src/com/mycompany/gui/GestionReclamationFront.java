...
import com.mycomany.utils.AlertUtils;
import com.codename1.ui.*;
import com.codename1.ui.layouts.BoxLayout;
public class GestionReclamationFront extends Form {
    ...
    public GestionReclamationFront(Form previous) {
        super(ListReclamationFront.currentReclamation == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentReclamation = ListReclamationFront.currentReclamation;
    ...
    private void showBackAndRefresh() {
        ((ListReclamationFront) previous).refresh();
        previous.showBack();
    }
