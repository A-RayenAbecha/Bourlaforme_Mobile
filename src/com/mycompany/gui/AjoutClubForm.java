 ...
 */
public class AjoutClubForm extends BaseForm  {
   
     Form current;
    public AjoutClubForm(Resources res)
    {
            ...
            try {
                ...
                if(nom.getText().equals("") || description.getText().equals(""))  {
                   ...
                   Club r = new Club(
                           ...
                           String.valueOf(type_activite.getText()).toString() ,
                    ...
                    ServiceClub.getInstance().ajoutClub(r);
