 ...
 * @author Lenovo
 */
public class SuppCommentaireForm extends BaseForm {
    
    
    Form current;
    public SuppCommentaireForm(Resources res ) {
        ...
        setTitle("Supprimer Reclamation");
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(objet.getText().equals("") ) {
                    ...
                    Commentaire ar = new Commentaire(id);
                    
                    System.out.println("data  reclamation == "+id);
