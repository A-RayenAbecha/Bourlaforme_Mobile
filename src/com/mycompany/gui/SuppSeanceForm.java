 ...
 * @author Lenovo
 */
public class SuppSeanceForm extends BaseForm {
    
    
    Form current;
    public SuppSeanceForm(Resources res ) {
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(objet.getText().equals("") ) {
                    ...
                    System.out.println("data  seance == "+id);
                    
                    
                    //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base 
                    ServiceSeance.getInstance().deleteSeance(id);
