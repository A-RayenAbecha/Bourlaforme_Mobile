 ...
 * @author Lenovo
 */
public class SuppPartiForm extends BaseForm {
    
    
    Form current;
    public SuppPartiForm(Resources res ) {
        ...
        setTitle("Supprimer Participation");
        ...
        TextField objet = new TextField("", "entrer Id!!");
       ...
       /* TextField description = new TextField("", "entrer description!!");
        ...
        Button btnAjouter = new Button("Supprimer");
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(objet.getText().equals("") ) {
                    ...
                    int id =Float.valueOf(objet.getText()).intValue();
                    //njibo iduser men session (current user)
                    Participation ar = new Participation(id);
                    
                    System.out.println("data  participation == "+id);
                    
                    
                    //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base 
                    ServiceParticipation.getInstance().deleteParticipation(id);
